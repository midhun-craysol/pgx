(function (a, b) {
  ...
  var m = {
    dialog:
      "<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog'><div class='modal-content'><div class='modal-body'><div class='bootbox-body pl-3'></div></div></div></div></div>",
  ...
  function b(q) {
    ...
    k(s, function (v, u, t) {
      ...
      if (!u.className) {
        if (r <= 2 && t === r - 1) {
          u.className = "btn-primary btn-sm";
        } else {
